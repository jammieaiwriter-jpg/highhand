...
MILESTONES = [
    ("1F門禁完成(玻璃/新美門/鐵捲門/防火門)", date(2026, 10, 7), "玲嬅9/16裁示:依會議標題改10/7前完成(原9/30)"),
    ("拆圍籬、景觀開挖", date(2026, 10, 5), "玲嬅9/9裁示:開挖10/5(否決柏銘10/30案);借地10/1~116/2/28不變"),
    ("2F~1F外牆拆架完成", date(2026, 11, 10), "玲嬅9/16裁示:2F~1F拆架11/9~11/10(9/16會議提前,原11/13~11/15),里程碑11/10;8F~2F拆架9/30~10/3"),
    ("消防檢查開始", date(2026, 11, 15), "9/2會議延11/15~116/1/15⚠️尾端壓使照;前置:消防變更10/2送件"),
    ("無障礙掛件", date(2026, 11, 15), "玲嬅9/21裁示:改回11/15(看現場維持12/5,掛件須在前;9/9曾延12月底)"),
    ("無障礙、使管處看現場", date(2026, 12, 5), "使照取得前送資料即可"),
    ("取得使用執照", date(2027, 1, 15), "玲嬅9/21裁示:改回116/1/15(9/9曾延116/1月底;9/16會議秘書長反推目標1/31未採)"),
]
...
MS_ORDER = [
    ("1F門禁", date(2026, 10, 7), "玻璃/新美門/鐵捲門(青岱)/防火門(佳昇)——拆圍籬(10/5)的前置；玲嬅9/16裁示改10/7前完成(原9/30)", date(2026, 10, 7), True, True),
    ("拆架2-7F", date(2026, 10, 3), "9/16會議8樓三角架復原表:8F~2F拆架9/30~10/3(玲嬅9/16裁示)；外牆清洗9/20~9/29、冷氣架格柵9/17~9/21須趕在拆架前完成", date(2026, 10, 3), True, True),
    ("拆架1-2F", date(2026, 11, 10), "9/16會議2樓三角架復原表:2F~1F拆架11/9~11/10(原11/13~11/15,玲嬅9/16裁示)：車道格柵/車道天花板油漆/2F~1F清潔(10/31~11/8)須先完成", date(2026, 11, 10), True, True),
